...
class NominaEngine:
    ...
    def _procesar_empleado(self, empleado: Empleado) -> EmpleadoCalculo:
        ...
        emp_calculo.salario_bruto = (
            emp_calculo.salario_base + emp_calculo.total_percepciones
        )
        ...
        emp_calculo.salario_neto = (
            emp_calculo.salario_bruto - emp_calculo.total_deducciones
        )
    ...
    def _procesar_percepciones(self, emp_calculo: EmpleadoCalculo) -> None:
        ...
        for planilla_percepcion in self.planilla.planilla_percepciones:
            ...
            if (
                percepcion.vigente_desde
                and percepcion.vigente_desde > self.fecha_calculo
            ):
                continue
    ...
    def _procesar_prestaciones(self, emp_calculo: EmpleadoCalculo) -> None:
        ...
        for planilla_prestacion in self.planilla.planilla_prestaciones:
            ...
            # Check validity dates
            if (
                prestacion.vigente_desde
                and prestacion.vigente_desde > self.fecha_calculo
            ):
                continue
