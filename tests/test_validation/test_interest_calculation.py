...
class TestIntersPeriodo:
    ...
    def test_calcular_interes_periodo_30_dias(self):
        ...
        interes, dias = calcular_interes_periodo(
            saldo, tasa_anual, fecha_desde, fecha_hasta, TipoInteres.SIMPLE
        )
    ...
    def test_calcular_interes_periodo_compuesto(self):
        ...
        interes, dias = calcular_interes_periodo(
            saldo, tasa_anual, fecha_desde, fecha_hasta, TipoInteres.COMPUESTO
        )
    ...
    def test_calcular_interes_periodo_fechas_iguales(self):
        ...
        interes, dias = calcular_interes_periodo(
            saldo, tasa_anual, fecha_desde, fecha_hasta
        )
...
class TestTablaAmortizacion:
    ...
    def test_generar_tabla_frances_sin_interes(self):
        ...
        tabla = generar_tabla_amortizacion(
            principal, tasa_anual, num_cuotas, fecha_inicio, MetodoAmortizacion.FRANCES
        )
    ...
    def test_generar_tabla_aleman_con_interes(self):
        ...
        tabla = generar_tabla_amortizacion(
            principal, tasa_anual, num_cuotas, fecha_inicio, MetodoAmortizacion.ALEMAN
        )
    ...
    def test_generar_tabla_fechas_consecutivas(self):
        ...
        tabla = generar_tabla_amortizacion(
            principal, tasa_anual, num_cuotas, fecha_inicio
        )
