...
class TestFormulaEngineInitialization:
    ...
    def test_init_with_valid_schema(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "calculate", "type": "calculation", "formula": "salario * 2"}
            ],
            "output": "calculate"
        }
    ...
    def test_init_step_without_name(self):
        ...
        schema = {
            "steps": [{"type": "calculation", "formula": "1 + 1"}]
        }
...
class TestCompleteExecution:
    ...
    def test_execute_multiple_steps(self):
        ...
        schema = {
            "inputs": [
                {"name": "base_salary", "default": 10000},
                {"name": "bonus_rate", "default": 0.1}
            ],
            "steps": [
    ...
    def test_execute_progressive_tax_calculation(self):
        ...
        schema = {
            ...
            "inputs": [
                {"name": "annual_income", "default": 150000}
            ],
            "steps": [
                {
                    "name": "tax",
                    "type": "tax_lookup",
                    "table": "progressive_rates",
                    "input": "annual_income"
                },
                {
                    "name": "monthly_tax",
    ...
    def test_execute_step_error_provides_context(self):
        ...
        schema = {
            "inputs": [{"name": "x", "default": 10}],
            "steps": [
                {"name": "bad_step", "type": "calculation", "formula": "undefined_var * 2"}
            ],
            "output": "bad_step"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_unknown_step_type(self):
        ...
        schema = {
            "inputs": [],
            "steps": [
                {"name": "unknown", "type": "invalid_type", "value": 100}
            ],
            "output": "unknown"
        }
        engine = FormulaEngine(schema)
...
class TestBadInputHandling:
    ...
    def test_execute_with_string_instead_of_number(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "tax", "type": "calculation", "formula": "salary * 0.15"}
            ],
            "output": "tax"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_invalid_string_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "amount * 2"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_none_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "total", "type": "calculation", "formula": "bonus * 2"}
            ],
            "output": "total"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_empty_string_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "value + 10"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_negative_numbers(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "adjustment + 100"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_very_large_numbers(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "big_num / 1000"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_very_small_decimals(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "tiny * 1000000"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_special_float_values(self):
        ...
        schema = {
            "inputs": [{"name": "x", "default": 100}],
            "steps": [
                {"name": "result", "type": "calculation", "formula": "x * 2"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_list_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "data * 2"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_dict_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "config + 10"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_boolean_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "flag * 100"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_execute_with_mixed_type_operations(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "int_val + float_val + str_val"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_empty_formula_string(self):
        ...
        schema = {
            "inputs": [{"name": "x", "default": 10}],
            "steps": [
                {"name": "result", "type": "calculation", "formula": ""}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_missing_input_uses_default(self):
        ...
        schema = {
            "inputs": [
                {"name": "required", "default": 100},
                {"name": "optional", "default": 50}
            ],
            "steps": [
                {"name": "result", "type": "calculation", "formula": "required + optional"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_scientific_notation_input(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "scientific * 2"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_decimal_precision_preservation(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "precise * 3"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_unicode_in_variable_names(self):
        ...
        schema = {
            ...
            "steps": [
                {"name": "result", "type": "calculation", "formula": "normal_var * 2"}
            ],
            "output": "result"
        }
        engine = FormulaEngine(schema)
    ...
    def test_assignment_with_invalid_value_type(self):
        ...
        schema = {
            "inputs": [],
            "steps": [
                {"name": "constant", "type": "assignment", "value": [1, 2, 3]}
            ],
            "output": "constant"
        }
        engine = FormulaEngine(schema)
