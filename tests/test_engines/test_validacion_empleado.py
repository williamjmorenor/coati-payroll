...
class TestValidacionEmpleadoCompleta:
    """Integration tests for complete employee validation."""
    
    def test_empleado_valido_procesa_correctamente(self, app, db_session):
        """Test that a fully valid employee processes correctly."""
        from coati_payroll.model import (
            Empresa, Moneda, TipoPlanilla, Planilla, Empleado,
            PlanillaEmpleado
        )
        ...
        with app.app_context():
            ...
            # Fully valid employee
            empleado = Empleado(
                codigo_empleado="EMP001",
                primer_nombre="Roberto",
                primer_apellido="Hernández",
                identificacion_personal="001-090194-0009I",
            ...
            assert nomina.total_neto == Decimal("25000.00")
