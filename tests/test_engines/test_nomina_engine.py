...
class TestConceptCalculatorFormulaMethods:
    ...
    def test_calculate_regla_calculo_by_prestacion_codigo(self, app, db_session):
        """Test _calculate_regla_calculo finds ReglaCalculo by prestacion codigo."""
        from coati_payroll.model import (
            Planilla,
            TipoPlanilla,
            Moneda,
        ...
        with app.app_context():
            ...
            regla = ReglaCalculo(
                codigo="INATEC_RULE_001",
                nombre="INATEC Rule",
                descripcion="Regla ligada por prestacion_id",
    ...
    def test_calculate_legacy_formula_personalizada_with_rule_code_fallback(self, app, db_session):
        """Test legacy formula_personalizada resolves rule by code when FK links are missing."""
        from coati_payroll.model import (
            Planilla,
            TipoPlanilla,
            Moneda,
        ...
        with app.app_context():
            ...
            concepto_codigo = "bmonic_INATECv_lct2019"
            regla_codigo = "bmonic_REGLA_INATECv_lct2019"

            prestacion = Prestacion(
                codigo=concepto_codigo,
                nombre="INATEC",
                descripcion="Aporte INATEC",
                formula_tipo="formula_personalizada",  # legacy value used by plugin
                activo=True,
            )
            db_session.add(prestacion)
            db_session.flush()
            ...
            # Legacy dataset: rule exists by code but has no FK links.
            regla = ReglaCalculo(
                codigo=regla_codigo,
                nombre="INATEC Rule",
                descripcion="Regla sin FK enlazada por convencion de codigo",
                tipo_regla="prestacion",
                esquema_json=esquema,
                vigente_desde=date(2024, 1, 1),
                activo=True,
            ...
            monto = calculator.calculate(
                ...
                monto_override=None,
                porcentaje_override=None,
                codigo_concepto=concepto_codigo,
            )
